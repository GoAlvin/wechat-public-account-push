export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx1d57c5d17c005645",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "c8b5b3a9a65acd2bd360a65b5f44d364",
  ...
  USERS: [
    {
      ...
      id: "owwS858WByAc4UA3hhP2I_h4ErjA",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "s_8YVCz4VS2znno7x4XNWlZyBUzISIZ-y8l5Kmg9WQI",
      // 所在省份
      province: "湖北",
      // 所在城市
      city: "武汉",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "然然", "year": "1999", "date": "11-26"},
        {"type": "节日", "name": "恋爱纪念日", "year": "2022", "date": "08-16"},
      ],
